export default {
     ...
     * Overview
     */
    description: 'Die UNSC-Infinity ist das Kronjuwel der menschlichen Weltraumflotte. Doch zuletzt machten sich immer wieder ' +
    ...
    step1_1: {
        ...
        questionType: "MARK",
        option1: {img: "blockList", sprite: "figurFisch", height: "400px", selectorData: [{height:"52px",width:"5px"},{height:"17px",width:"10px"},{height:"45px",width:"5px"},{height:"50px",width:"5px"},{height:"18px",width:"3px"},{height:"18px",width:"3px"},{height:"38px",width:"3px"}]},
        option2: {img: "blockList", sprite: "figurKatze", height: "100px", selectorData: [{height:"200px",width:"5px"},{height:"220px",width:"10px"},{height:"50px",width:"5px"}]},
        option3: {img: "bewegung", sprite: "figurFledermaus", height: "100px", selectorData: [{height:"20px",width:"5px"},{height:"20px",width:"10px"},{height:"50px",width:"5px"}]},
        possibleAnswers: ["option1_2","option2_1"], //can be selected
        necessaryAnswers: ["option1_0","option1_1"], //at least on of them needs to be selected. INDEX 0-Indiziert!
    ...
    step1_1d: {
        ...
        option1_0: {next: "step1_1s", img: "bewegung", width: "100px"},
        option1_1: {next: "step1_1s", img: "aussehen", width: "100px"},
        option1_2: {next: "wrongAnswer", img: "klang", width: "100px"},
        correctionText: "Bist du dir wirklich sicher?",
    ...
    step1_4: {
        ...
        correctionText: "Bist du dir wirklich sicher?",
        help: "Welche der Auswahloptionen passt am ehesten, wenn das Raumschiff sich nicht bewegt?",
        diagrammStep: "3",
    },
