...
const isBowl = sprite => sprite.name.toLowerCase().match(/(bowl|schale)/);
...
const testVariableInitialization = async function (t) {
    ...
    t.end();
    console.log("stop step4_1");
};

const testBowlInitialization = async function (t) {
    console.log("start step4_2");
    t.seedScratch('seed');
    ...
    t.end();
    console.log("stop step4_2");
};

const testFruitInitialization = async function (t) {
    console.log("start step4_3");
    t.seedScratch('seed');

    const {apple} = getSpritesAndVariables(t, ['apple']);

    /* Give the program seed time to initialize. */
    await t.runForTime(() => apple.size === 50, 500);

    t.assert.equal(apple.size, 50, 'Apple must have a size of 50%.');

    t.end();
    console.log("stop step4_3");
};

// -------------------- Bowl Movement ------------------------------------------

const testMoveBowl = async function (t, testDetails = false) {
    console.log("start step4_4");
    t.seedScratch('seed');
    ...
    t.end();
    console.log("stop step4_4");
};

const testMoveBowlDetails = async function (t) {
    console.log("start step4_5");
    t.seedScratch('seed');

    await testMoveBowl(t, true);
    t.end();
    console.log("stop step4_5");
};
...
const testOnlyOneApple = async function (t) {
    console.log("start step4_16");
    await testOnlyOneFruit(t, isApple, 'Apple');
    t.end();
    console.log("stop step4_16");
};
...
const testTimerTick = async function (t) {
    ...
    t.end();
    console.log("stop step4_26");
};

const testTimerGameOver = async function (t) {
    console.log("start step4_27");
    t.seedScratch('seed');
    ...
    t.end();
    console.log("stop step4_27");
};

const testTimerGameOverMessage = async function (t) {
    console.log("start step4_28");
    t.seedScratch('seed');
...
module.exports = [
    { // 03
        ...
        description: 'Tests the initialization of the size of apples. Apples have a size of 50%.',
        categories: ['initialization', 'apple']
    },
    { // 06
        id: 'step3_6',
