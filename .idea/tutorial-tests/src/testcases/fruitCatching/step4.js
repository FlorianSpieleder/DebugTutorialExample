...
const testFruitInitialization = async function (t) {
    ...
    const {banana} = getSpritesAndVariables(t, ['banana']);

    /* Give the program seed time to initialize. */
    await t.runForTime(() => banana.size === 50, 500);
...
module.exports = [
    { // 03
        ...
        description: 'Tests the initialization of the size of bananas. bananas must have a size of 50%.',
        categories: ['initialization', 'banana']
    },
    { // 08
        id: 'step4_8',
